...
class StepOne extends React.Component {
    ...
    changeNext = (gotVal) => {
        if (!this.state.h20_q)
        { console.log("If" +this.state.h20_q); }
        else { console.log("Else" + this.state.h20_q); }
    }
        ...
        return (
          ...
          <React.Fragment>
                <div className="text-center mt-4">
                    ...
                    <h1 className="h2">State Eligibility</h1>
                ...
                <FormGroup check className="mb-2">
                    <Label check>
                        <Input 
                            ...
                            name="h20_q"
                            value="yes"
                            onChange={(e) => { this.setState({ h20_q: e.target.value }) }}
                            onClick={this.props.changeNext}
                           />
                        Yes
                    </Label>
                </FormGroup>
